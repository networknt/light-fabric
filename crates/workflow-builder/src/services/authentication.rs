use workflow_core::models::authentication::*;
...
impl BasicAuthenticationSchemeDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            scheme: BasicAuthenticationSchemeDefinition::default(),
        }
    }
...
impl BearerAuthenticationSchemeDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            scheme: BearerAuthenticationSchemeDefinition::default(),
        }
    }
...
impl CertificateAuthenticationSchemeDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            scheme: CertificateAuthenticationSchemeDefinition::default(),
        }
    }
...
impl DigestAuthenticationSchemeDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            scheme: DigestAuthenticationSchemeDefinition::default(),
        }
    }
...
impl OAuth2AuthenticationSchemeDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            scheme: OAuth2AuthenticationSchemeDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut OAuth2AuthenticationClientDefinitionBuilder),
    {
    ...
    where
        F: FnOnce(&mut OAuth2AuthenticationRequestDefinitionBuilder),
    {
...
impl OpenIDConnectSchemeDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            scheme: OpenIDConnectSchemeDefinition::default(),
        }
    }
...
impl OAuth2AuthenticationClientDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            client: OAuth2AuthenticationClientDefinition::default(),
        }
    }
...
impl OAuth2AuthenticationRequestDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            request: OAuth2AuthenticationRequestDefinition::default(),
        }
    }
