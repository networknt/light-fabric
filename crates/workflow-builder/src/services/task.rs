...
use workflow_core::models::duration::*;
use workflow_core::models::error::*;
use workflow_core::models::event::*;
use workflow_core::models::input::*;
use workflow_core::models::map::*;
use workflow_core::models::output::*;
use workflow_core::models::resource::*;
use workflow_core::models::retry::*;
use workflow_core::models::schema::*;
use workflow_core::models::task::*;
use workflow_core::models::timeout::*;
...
impl CalltaskDefinitionBuilder {
    ...
    pub fn new(function: &str) -> Self {
        Self {
            task: CallTaskDefinition::new_function(function, None, None),
        }
    }
...
impl TaskDefinitionBuilderBase for CalltaskDefinitionBuilder {
    ...
    /// Sets the task's timeout
    fn with_timeout_reference(&mut self, reference: &str) -> &mut Self {
        self.task.common_mut().timeout = Some(OneOfTimeoutDefinitionOrReference::Reference(
            reference.to_string(),
        ));
        self
    }
...
impl DoTaskDefinitionBuilder {
    ...
    where
        F: FnOnce(&mut GenericTaskDefinitionBuilder),
    {
...
impl EmitTaskDefinitionBuilder {
    ...
    pub fn new(event: EventDefinition) -> Self {
        Self {
            task: EmitTaskDefinition::new(EventEmissionDefinition::new(event)),
        }
    }
}
...
impl ForTaskDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            task: ForTaskDefinition::default(),
        }
    }
...
impl ForkTaskDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            task: ForkTaskDefinition::default(),
        }
    }
...
impl ListenTaskDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            task: ListenTaskDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut EventConsumptionStrategyDefinitionBuilder),
    {
    ...
    where
        F: FnOnce(&mut SubscriptionIteratorDefinitionBuilder),
    {
...
impl TaskDefinitionBuilderBase for RaiseTaskDefinitionBuilder {
    ...
    /// Sets the task's timeout
    fn with_timeout_reference(&mut self, reference: &str) -> &mut Self {
        self.common.timeout = Some(OneOfTimeoutDefinitionOrReference::Reference(
            reference.to_string(),
        ));
        self
    }
    ...
    fn build(self) -> TaskDefinition {
        ...
        if let Some(builder) = self.builder {
            ...
            task.raise =
                RaiseErrorDefinition::new(OneOfErrorDefinitionOrReference::Reference(reference));
        } else {
...
impl RunTaskDefinitionBuilder {
    ...
    pub fn container(&mut self) -> &mut ContainerProcessDefinitionBuilder {
        self.builder = Some(ProcessDefinitionBuilder::Container(
            ContainerProcessDefinitionBuilder::new(),
        ));
    ...
    pub fn script(&mut self) -> &mut ScriptProcessDefinitionBuilder {
        self.builder = Some(ProcessDefinitionBuilder::Script(
            ScriptProcessDefinitionBuilder::new(),
        ));
    ...
    pub fn shell(&mut self) -> &mut ShellProcessDefinitionBuilder {
        self.builder = Some(ProcessDefinitionBuilder::Shell(
            ShellProcessDefinitionBuilder::new(),
        ));
    ...
    pub fn workflow(&mut self) -> &mut WorkflowProcessDefinitionBuilder {
        self.builder = Some(ProcessDefinitionBuilder::Workflow(
            WorkflowProcessDefinitionBuilder::new(),
        ));
...
impl SetTaskDefinitionBuilder {
    ...
    pub fn variable(&mut self, name: &str, value: Value) -> &mut Self {
        match &mut self.task.set {
            workflow_core::models::task::SetValue::Map(map) => {
                map.insert(name.to_string(), value);
            }
            workflow_core::models::task::SetValue::Expression(_) => {
                // If it was an expression, convert to map
                let mut map = HashMap::new();
                map.insert(name.to_string(), value);
                self.task.set = workflow_core::models::task::SetValue::Map(map);
            }
        }
        self
    }
    ...
    pub fn variable_expression(&mut self, expression: String) -> &mut Self {
        self.task.set = workflow_core::models::task::SetValue::Expression(expression);
        self
    }

    /// Configures the task to set the specified variables
    pub fn variables(&mut self, variables: HashMap<String, Value>) -> &mut Self {
        self.task.set = workflow_core::models::task::SetValue::Map(variables);
        self
    }
}
...
impl TryTaskDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            task: TryTaskDefinition::default(),
        }
    }
    ...
    pub fn build(self) -> EventConsumptionStrategyDefinition {
        ...
        if let Some(all_builder) = self.all {
            ...
            if let Some(expression) = self.until_condition {
                strategy.until = Some(Box::new(
                    OneOfEventConsumptionStrategyDefinitionOrExpression::Expression(
                        expression.to_string(),
                    ),
                ));
            } else if let Some(until_events) = self.until_events {
                strategy.until = Some(Box::new(
                    OneOfEventConsumptionStrategyDefinitionOrExpression::Strategy(until_events),
                ));
            }
...
impl SubscriptionIteratorDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            iterator: SubscriptionIteratorDefinition::new(),
        }
    }
...
impl ContainerProcessDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            process: ContainerProcessDefinition::default(),
        }
    }
...
impl ScriptProcessDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            process: ScriptProcessDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut ExternalResourceDefinitionBuilder),
    {
...
impl ShellProcessDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            process: ShellProcessDefinition::default(),
        }
    }
...
impl WorkflowProcessDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            process: WorkflowProcessDefinition::default(),
        }
    }
...
impl ExternalResourceDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            resource: ExternalResourceDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut EndpointDefinitionBuilder),
    {
...
impl EndpointDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            endpoint: EndpointDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut AuthenticationPolicyDefinitionBuilder),
    {
        let mut builder = AuthenticationPolicyDefinitionBuilder::new();
        setup(&mut builder);
        let authentication = builder
            .build()
            .expect("The authentication policy must be configured");
...
impl SwitchCaseDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            case: SwitchCaseDefinition::default(),
        }
    }
...
impl ErrorCatcherDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            catch: ErrorCatcherDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut ErrroFilterDefinitionBuilder),
    {
        ...
        F: FnOnce(&mut RetryPolicyDefinitionBuilder),
    {
        ...
        setup(&mut builder);
        self.catch.retry = Some(OneOfRetryPolicyDefinitionOrReference::Retry(
            builder.build(),
        ));
        self
    }
    ...
    pub fn retry_using(&mut self, reference: &str) -> &mut Self {
        self.catch.retry = Some(OneOfRetryPolicyDefinitionOrReference::Reference(
            reference.to_string(),
        ));
        self
    }
...
impl RetryPolicyDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            retry: RetryPolicyDefinition::default(),
        }
    }
    ...
    where
        F: FnOnce(&mut RetryPolicyLimitDefinitionBuilder),
    {
    ...
    where
        F: FnOnce(&mut GenericBackoffStrategyDefinitionBuilder),
    {
...
impl RetryAttemptLimitDefinitionBuilder {
    ...
    pub fn new() -> Self {
        Self {
            attempt: RetryAttemptLimitDefinition::default(),
        }
    }
