...
qualification remain open under [issue #379](https://github.com/networknt/light-fabric/issues/379).
Stateless support is opt-in: both Rust and the shipped template default to
disabled. Final specification artifacts are pinned in the implementation
...
The design-to-implementation phase crosswalk is: design 0 → implementation
0–1; design 1 → 2–3; design 2 → 4–5; design 3 → 6; design 4 → 9;
design 5 → 8; design 6 → 7. Phase 9 remains explicitly closed without an
automatic backend probe or stateless-to-legacy bridge.
...
- [Final protocol changelog](https://modelcontextprotocol.io/specification/2026-07-28/changelog)
...
- [Final base protocol](https://modelcontextprotocol.io/specification/2026-07-28/basic/index)
- [Final Streamable HTTP transport](https://modelcontextprotocol.io/specification/2026-07-28/basic/transports/streamable-http)
- [Final discovery contract](https://modelcontextprotocol.io/specification/2026-07-28/server/discover)
- [Final tools contract](https://modelcontextprotocol.io/specification/2026-07-28/server/tools)
- [Final authorization contract](https://modelcontextprotocol.io/specification/2026-07-28/basic/authorization)
