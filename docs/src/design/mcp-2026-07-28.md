...
are normative: legacy enabled, stateless available by default, and stateless-to-legacy
bridging rejected.
...
13. Stateless support is built in; release qualification remains a separate process.
