...
- [Light CLI](design/light-cli.md)
- [Workload Identity Issuance](design/workload-identity-issuance.md)
...
- [Light-Gateway](product/light-gateway.md)
  ...
  - [LLM Gateway](product/light-gateway/llm-gateway.md)
    ...
    - [Codex CLI Provider Option (Deferred)](product/llm-gateway/codex-cli-provider.md)
    - [Claude Code CLI Provider Option (Deferred)](product/llm-gateway/claude-code-cli-provider.md)
